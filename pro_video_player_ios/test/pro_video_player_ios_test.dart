...
void main() {
  ...
  group('ProVideoPlayerIOS', () {
    ...
    group('create', () {
      ...
      // TODO: Re-enable when bufferingTier is added to Pigeon schema
      ...
      //   );
      //
      //   expect(harness.lastCall.options.bufferingTier, equals('high'));
      // });
      //
      ...
      //
      //   expect(harness.lastCall.options.bufferingTier, equals('medium'));
      // });

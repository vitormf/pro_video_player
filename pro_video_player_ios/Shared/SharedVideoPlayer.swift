...
class SharedVideoPlayer: NSObject {
    ...
    private func setupPlayer(source: [String: Any], options: [String: Any]) {
        ...
        // Setup remote command center if background playback is enabled
    ...
    private func setupObservers() {
        ...
        // Observe app background state for auto-PiP
    ...
    func setBackgroundPlayback(_ enabled: Bool) -> Bool {
        ...
        if success {
            ...
            if enabled {
                // Set up remote command center if newly enabled
                setupRemoteCommandCenter()
                updateNowPlayingInfo()
            } else {
                // Clear remote command center if disabled

  ...
  group('AudioButton', () {
    testWidgets('renders icon button with correct icon', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: AudioButton(theme: VideoPlayerTheme.light(), onPressed: () {}),
          ),
        ),
      );
    ...
    testWidgets('uses theme primary color for icon', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: AudioButton(theme: customTheme, onPressed: () {}),
          ),
        ),
      );
    ...
    testWidgets('calls onPressed when tapped', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: AudioButton(theme: VideoPlayerTheme.light(), onPressed: () => pressed = true),
          ),
        ),
      );

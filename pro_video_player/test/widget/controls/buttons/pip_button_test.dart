...
import 'package:pro_video_player/src/controls/buttons/pip_button.dart';
...
void main() {
  group('PipButton', () {
    testWidgets('renders icon button with correct icon', (tester) async {
      await tester.pumpWidget(buildTestWidget(PipButton(theme: VideoPlayerTheme.light(), onPressed: () {})));

      // Should show PiP icon
    ...
    testWidgets('uses theme primary color for icon', (tester) async {
      ...
      await tester.pumpWidget(buildTestWidget(PipButton(theme: customTheme, onPressed: () {})));
    ...
    testWidgets('calls onPressed when tapped', (tester) async {
      ...
      await tester.pumpWidget(
        buildTestWidget(PipButton(theme: VideoPlayerTheme.light(), onPressed: () => pressed = true)),
      );

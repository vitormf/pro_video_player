...
class ProVideoPlayerPlugin: FlutterPlugin, MethodCallHandler, ActivityAware, Application.ActivityLifecycleCallbacks, EventChannel.StreamHandler {
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(binding.binaryMessenger, "com.example.pro_video_player_android/methods")
        channel.setMethodCallHandler(this)

        // Set up battery event channel
        batteryEventChannel = EventChannel(binding.binaryMessenger, "com.example.pro_video_player_android/batteryUpdates")
        batteryEventChannel.setStreamHandler(this)

        // Register the platform view factory
        binding.platformViewRegistry.registerViewFactory(
            "com.example.pro_video_player_android/video_view",
        ...
        binding.platformViewRegistry.registerViewFactory(
            "com.example.pro_video_player_android/cast_button",
